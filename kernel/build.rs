...
//!  2. Compile the freestanding C (`c/support.c`) and assembly (`asm/cpu.s`)
//!     support objects for the kernel target and archive them into a static
//!     lib that rustc links into the kernel ELF (mixed-language integration).
//!
...
/// Compile one C or assembly source into an object for the freestanding kernel.
